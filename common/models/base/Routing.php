 ...
 *
 * @property \common\models\Domain $domain
 * @property \common\models\D123 $d123
 * @property \common\models\A123 $a123
 */
abstract class Routing extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasOne(\common\models\Domain::class, ['id' => 'domain_id']);
    }

    public function getD123()
    {
        return $this->hasOne(\common\models\D123::class, ['id' => 'd123_id']);
    }

    public function getA123()
    {
        return $this->hasOne(\common\models\A123::class, ['id' => 'a123_id']);
    }
}
